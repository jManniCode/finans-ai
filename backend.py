...
def get_conversational_chain(vector_store):
    ...
    system_prompt = (
        ...
        "IMPORTANT: For 'line' charts, ensure that all time periods in the series have the same consistency (e.g., all are full years, or all are single quarters). "
        "Do NOT mix different period types (like 'Q3' and 'Full Year') in a single 'line' chart. "
        "If the data contains mixed period types (e.g., Single Quarter vs Year-to-Date vs Full Year), use a 'bar' chart instead. "
...
def generate_summary_charts(chain):
    ...
    prompt_text = (
        ...
        "\n\n"
        "Constraint: For 'line' charts, NEVER mix different period lengths (e.g. do not mix Q3 and Full Year). "
        "If the available data has mixed period types, strictly use 'bar' charts. "
        "\n\n"
